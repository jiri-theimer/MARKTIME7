...
namespace BL
{
    public abstract class ColumnsProviderBase
    {
        ...
        public void AppendProjectColumns(string prefix)
        {
            ...
            oc = AF("NakladovyHonorar", "Nákl.honorář", "p41vykony.Honorar_Naklad", "num", true); oc.VYSL = true; oc.RelSqlInCol = strP41VykaSQL; oc.VYSL = true;
            oc = AF("RezijniHonorar", "Režijní honorář", "p41vykony.Honorar_Rezijni", "num", true); oc.VYSL = true; oc.RelSqlInCol = strP41VykaSQL; oc.VYSL = true;
            oc = AF("NakladovyPlusRezijniHonorar", "Nákl.+Režj.honorář", "isnull(p41vykony.Honorar_Naklad,0)+isnull(p41vykony.Honorar_Rezijni,0)", "num", true); oc.VYSL = true; oc.RelSqlInCol = strP41VykaSQL; oc.VYSL = true;
