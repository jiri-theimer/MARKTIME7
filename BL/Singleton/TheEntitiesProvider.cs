...
namespace BL.Singleton
{
    public class TheEntitiesProvider
    {
        ...
        private void SetupPallete()
        {
            ...
            AE("p78UpominkaSdruzena", "Hromadné upomínky", "Hromadná upomínka", "p78UpominkaSdruzena a INNER JOIN p28Contact p28x ON a.p28ID=p28x.p28ID", "a.p78ID DESC");
        ...
        public List<BO.EntityRelation> getApplicableRelations(string strPrimaryPrefix, BL.Factory f)
        {
            ...
            switch (strPrimaryPrefix)
            {
                ...
                case "p84":
                    ...
                    break;
                case "p78":
                    lis.Add(getREL("p28Contact", "p78_p28", "Dlužník (vazba)", "LEFT OUTER JOIN p28Contact p78_p28 ON a.p28ID=p78_p28.p28ID"));
                    break;
                case "j06":
